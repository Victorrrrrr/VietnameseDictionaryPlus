...
object Base64Utils {
    ...
    fun encode(binaryData: ByteArray?): String? {
        ...
        for (i in 0 until numberTriplets) {
            ...
            encodedData[encodedIndex++] =
                lookUpBase64Alphabet[val2.toInt() or (k.toInt() shl 4)]
            encodedData[encodedIndex++] =
                lookUpBase64Alphabet[(l.toInt() shl 2) or val3.toInt()]
    ...
    fun decode(encoded: String?): ByteArray? {
        ...
        if (!isData((base64Data[dataIndex++].also {
                d1 = it
            })) || !isData((base64Data[dataIndex++].also {
                d2 = it
            }))) {
